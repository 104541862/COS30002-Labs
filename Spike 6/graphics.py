...
class GameWindow(pyglet.window.Window):
    ...
    def _add_handlers(self):
        ...
        def on_mouse_drag(x, y, dx, dy, buttons, modifiers):
            ...
            if game and game.world.active_slider:

                slider = game.world.active_slider

                slider.set_from_mouse(x)

                # push values into world
                game.world.sep_weight = game.world.sliders[0].value
                game.world.coh_weight = game.world.sliders[1].value
                game.world.ali_weight = game.world.sliders[2].value
                game.world.fear_radius = game.world.sliders[3].value
...
settings = {
    ...
    'vsync': True,
    'resizable': False,
    'caption': "Emergent Group Behaviours - Spike 6",
}
