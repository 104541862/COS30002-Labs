""" 
D-LEVEL CUSTOM PROJECT - Vector2D Module
This module defines the Vector2D class, which implements a 2D vector with common operations 
such as addition, scaling, normalization, and more. 
