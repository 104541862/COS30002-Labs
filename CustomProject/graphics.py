"""
D-LEVEL CUSTOM PROJECT - Graphics Module

This module defines the graphical components of the D-Level Custom Project, 
including shape groups, line primitives, and the main game window.
It provides a structured way to manage and render shapes using pyglet's graphics system.
