...
Run the two files. 
Notice that the "success" file runs properly as intended and the SGI will complete its tasks. For simple scenarios like this without any environment or side-effects, SGI works fine;
